...
function TopicsCategory({topics, className, onTopicSelect}) {
  return (
    ...
    <div className= " h-max border sticky   top-20 color-scrollbar overflow-y-hidden md:overflow-y-auto border-secondary justify-start md:items-start items-center  rounded-xl md:col-span-3 p-4 md:p-0 md:pb-1 col-span-12  md:flex-col flex  md:gap-0 gap-2">
      ...
      <ul className='w-full md:h-[300px] color-scrollbar flex md:flex-col p-4 md:p-0  md:overflow-y-auto  gap-1 '>
        {topics.map((topic) => (
