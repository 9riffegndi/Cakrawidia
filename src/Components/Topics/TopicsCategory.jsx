...
function TopicsCategory({topics, className, onTopicSelect}) {
  return (
    ...
    <div className= "md:min-h-screen border border-secondary justify-start items-center  rounded-md md:col-span-3 p-4 md:p-0 col-span-12  md:flex-col flex overflow-auto md:gap-0 gap-2">
